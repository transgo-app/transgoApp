...
class FilterBottomSheet extends StatelessWidget {
      ...
      widget: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            gabaritoText(text: "Pilih Lokasi*", fontSize: 14),
            ...
            GestureDetector(
              ...
              child: Obx(
                () => _SelectBox(
                  ...
                  icon: IconsaxPlusBold.calendar_edit,
                ),
              ),
            ),
            const SizedBox(height: 20),
            ...
            Obx(
              () => DurationDropdown(
                ...
                onSelectionChanged: (DurationOption option) {
  ...
  void _openTimePicker(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (_) {
        return _BottomTimePicker(controller: controller);
      },
    );
  }
}
...
class _BottomTimePickerState extends State<_BottomTimePicker> {
  ...
  void initState() {
    ...
    minTime = (pickedDate.year == now.year &&
        ...
        : DateTime(pickedDate.year, pickedDate.month, pickedDate.day, minHourLimit);
  ...
  Widget build(BuildContext context) {
    ...
    final int availableHours =
        (maxHourLimit - startHour + 1).clamp(0, 24);
