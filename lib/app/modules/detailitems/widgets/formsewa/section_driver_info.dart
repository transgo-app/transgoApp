      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildBulletPoint("BBM: Sesuai pemakaian atau dihitung Rp 1.600/km (Driver akan foto dashboard KM awal & akhir)."),
            _buildBulletPoint("Tol & Parkir: Dibayarkan penyewa sesuai pemakaian."),
            _buildBulletPoint("Overtime: Rp 50.000/jam jika pemakaian melebihi 12 jam."),
